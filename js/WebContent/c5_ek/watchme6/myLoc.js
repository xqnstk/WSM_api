...
//
function computeDistance(startCoords, destCoords) { //거리 계산 함수
...
function displayError(error) { //에러 처리
	var errorTypes = {
		0: "알려지지 않은 에러",
		1: "사용자가 권한 거부",
		2: "위치를 찾을 수 없음",
...
function watchLocation() {
	watchId = navigator.geolocation.watchPosition(displaylocation, desplayError);
}
